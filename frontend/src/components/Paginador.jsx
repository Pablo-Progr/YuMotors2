  ...
  return (
    <div className="paginador-container">
      <div className="paginador-controles">
        {/* Botón Inicio */}
        <button
          className="btn-paginador btn-inicio"
          onClick={irAlInicio}
        ...
        {totalPaginas > 10 && (
          <button
            className="btn-paginador btn-salto"
        ...
        {/* Botón Anterior */}
        <button
          className="btn-paginador btn-anterior"
          onClick={retroceder}
          disabled={paginaActual === 1}
        ...
        <div className="numeros-pagina">
          ...
          {numerosPagina.length > 0 && numerosPagina[0].numero > 1 && (
            <>
              ...
              {numerosPagina[0].numero > 2 && (
                <span className="puntos-suspension">...</span>
              )}
            </>
          )}
          ...
          {numerosPagina.map((item) => (
            <button
              key={item.numero}
              className={`btn-numero ${
                item.numero === paginaActual ? "activo" : ""
              }`}
        ...
        {/* Botón Siguiente */}
        <button
          className="btn-paginador btn-siguiente"
          onClick={avanzar}
        ...
        {/* Botón Final */}
        <button
          className="btn-paginador btn-final"
          onClick={irAlFinal}
          disabled={paginaActual === totalPaginas}
          title="Ir al final"
        >
          <span className="btn-text">Final</span>
